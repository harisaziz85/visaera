...
export default function BruneiEvisa() {
  return (
    <EVisaCountryPage
      country="Brunei"
      title="Apply Brunei E-Visa"
      flag="https://flagcdn.com/w320/bn.png"
      heroImage="https://images.unsplash.com/photo-1705583855040-3c25b4a9eab9?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1172"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Brunei-photo-guidelines.pdf" }],
      }}
      processingStages={[
