...
export default function MoldovaEvisa() {
  return (
    <EVisaCountryPage
      country="Moldova"
      title="Apply Moldova E-Visa"
      flag="https://flagcdn.com/w320/mo.png"
      heroImage="https://images.unsplash.com/photo-1593340646418-af8bc7d03b2e?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Moldova-photo-guidelines.pdf" }],
      }}
      processingStages={[
