...
export default function CameroonEvisa() {
  return (
    <EVisaCountryPage
      country="Cameroon"
      title="Apply Cameroon E-Visa"
      flag="https://flagcdn.com/w320/cm.png"
      heroImage="https://images.unsplash.com/photo-1659947234279-92bc8f2cd2fe?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1332"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Cameroon-photo-guidelines.pdf" }],
      }}
      processingStages={[
