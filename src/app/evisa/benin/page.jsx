...
export default function BeninEvisa() {
  return (
    <EVisaCountryPage
      country="Benin"
      title="Apply Benin E-Visa"
      flag="https://flagcdn.com/w320/bj.png"
      heroImage="https://images.unsplash.com/photo-1655682621708-5e42174d59ce?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1171"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Benin-photo-guidelines.pdf" }],
      }}
      processingStages={[
