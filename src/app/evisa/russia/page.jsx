...
export default function RussiaEvisa() {
  return (
    <EVisaCountryPage
      country="Russia"
      title="Apply Russia E-Visa"
      flag="https://flagcdn.com/w320/ru.png"
      heroImage="https://images.unsplash.com/photo-1690140733600-500682577f1d?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Russia-photo-guidelines.pdf" }],
      }}
      processingStages={[
