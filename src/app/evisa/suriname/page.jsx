...
export default function SurinameEvisa() {
  return (
    <EVisaCountryPage
      country="Suriname"
      title="Apply Suriname E-Visa"
      flag="https://flagcdn.com/w320/sr.png"
      heroImage="https://plus.unsplash.com/premium_photo-1670689707713-d6f9e1dc9a52?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1315"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Suriname-photo-guidelines.pdf" }],
      }}
      processingStages={[
