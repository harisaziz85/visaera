...
export default function ChileEvisa() {
  return (
    <EVisaCountryPage
      country="Chile"
      title="Apply Chile E-Visa"
      flag="https://flagcdn.com/w320/cl.png"
      heroImage="https://images.unsplash.com/photo-1729100636302-4eadc1910a70?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1332"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Chile-photo-guidelines.pdf" }],
      }}
      processingStages={[
