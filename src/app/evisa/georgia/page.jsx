...
export default function GeorgiaEvisa() {
  return (
    <EVisaCountryPage
      country="Georgia"
      title="Apply Georgia E-Visa"
      flag="https://flagcdn.com/w320/ge.png"
      heroImage="https://images.unsplash.com/photo-1705679548355-08750986b11e?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Georgia-photo-guidelines.pdf" }],
      }}
      processingStages={[
