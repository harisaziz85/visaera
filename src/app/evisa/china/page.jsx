...
export default function ChinaEvisa() {
  return (
    <EVisaCountryPage
      country="China"
      title="Apply China E-Visa"
      flag="https://flagcdn.com/w320/cn.png"
      heroImage="https://images.unsplash.com/photo-1474181487882-5abf3f0ba6c2?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/China-photo-guidelines.pdf" }],
      }}
      processingStages={[
