...
export default function cubaEvisa() {
  return (
    <EVisaCountryPage
      country="cuba"
      title="Apply cuba E-Visa"
      flag="https://flagcdn.com/w320/cu.png"
      heroImage="https://plus.unsplash.com/premium_photo-1697730131336-01d0886e8865?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1332"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/cuba-photo-guidelines.pdf" }],
      }}
      processingStages={[
