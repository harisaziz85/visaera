...
export default function AustriaEvisa() {
  return (
    <EVisaCountryPage
      country="Austria"
      title="Apply Austria E-Visa"
      flag="https://flagcdn.com/w320/as.png"
      heroImage="https://images.unsplash.com/photo-1597086831879-756db15e81d3?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1074"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Austria-photo-guidelines.pdf" }],
      }}
      processingStages={[
