...
export default function BotswanaEvisa() {
  return (
    <EVisaCountryPage
      country="Botswana"
      title="Apply Botswana E-Visa"
      flag="https://flagcdn.com/w320/bw.png"
      heroImage="https://images.unsplash.com/photo-1531208853003-c1ec1b8a81d7?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1233"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Botswana-photo-guidelines.pdf" }],
      }}
      processingStages={[
