...
export default function AlbaniaEvisa() {
  return (
    <EVisaCountryPage
      country="Albania"
      title="Apply Albania E-Visa"
      flag="https://flagcdn.com/w320/al.png"
      heroImage="https://plus.unsplash.com/premium_photo-1661962414231-8328a5ffd28b?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1185"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Albania-photo-guidelines.pdf" }],
      }}
      processingStages={[
