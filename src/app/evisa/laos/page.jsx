...
export default function LoasEvisa() {
  return (
    <EVisaCountryPage
      country="Loas"
      title="Apply Loas E-Visa"
      flag="https://flagcdn.com/w320/la.png"
      heroImage="https://images.unsplash.com/photo-1610426714962-83caa2244105?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1117"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Loas-photo-guidelines.pdf" }],
      }}
      processingStages={[
