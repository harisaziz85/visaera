...
export default function KenyaETA() {
  return (
    <EVisaCountryPage
      country="Kenya"
      title="Apply Kenya E-Visa"
      flag="https://flagcdn.com/w320/ke.png"
      heroImage="https://plus.unsplash.com/premium_photo-1670689708073-995104fd2e8d?w=1200&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGtlbnlhfGVufDB8fDB8fHww"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/kenya-photo-guidelines.pdf" }],
      }}
      processingStages={[
