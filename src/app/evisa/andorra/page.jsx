...
export default function AndorraEvisa() {
  return (
    <EVisaCountryPage
      country="Andorra"
      title="Apply Andorra E-Visa"
      flag="https://flagcdn.com/w320/ad.png"
      heroImage="https://images.unsplash.com/photo-1611917436955-d21c1999520c?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Andorra-photo-guidelines.pdf" }],
      }}
      processingStages={[
