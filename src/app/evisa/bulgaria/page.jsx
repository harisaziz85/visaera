...
export default function BulgariaEvisa() {
  return (
    <EVisaCountryPage
      country="Bulgaria"
      title="Apply Bulgaria E-Visa"
      flag="https://flagcdn.com/w320/bg.png"
      heroImage="https://images.unsplash.com/photo-1649932544138-081d3dfa61d6?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YnVsZ2FyaWElMjBuYXR1cmV8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&q=60&w=600"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Bulgaria-photo-guidelines.pdf" }],
      }}
      processingStages={[
