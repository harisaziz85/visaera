...
export default function JordanEvisa() {
  return (
    <EVisaCountryPage
      country="Jordan"
      title="Apply Jordan E-Visa"
      flag="https://flagcdn.com/w320/jo.png"
      heroImage="https://images.unsplash.com/photo-1714577745268-efa729c2ae4b?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Jordan-photo-guidelines.pdf" }],
      }}
      processingStages={[
