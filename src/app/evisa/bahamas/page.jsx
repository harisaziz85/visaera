...
export default function BahamasEvisa() {
  return (
    <EVisaCountryPage
      country="Bahamas"
      title="Apply Bahamas E-Visa"
      flag="https://flagcdn.com/w320/ba.png"
      heroImage="https://images.unsplash.com/photo-1717465760702-e2c057b0268f?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1137"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Bahamas-photo-guidelines.pdf" }],
      }}
      processingStages={[
