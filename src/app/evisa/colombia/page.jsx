...
export default function ColombiaEvisa() {
  return (
    <EVisaCountryPage
      country="Colombia"
      title="Apply Colombia E-Visa"
      flag="https://flagcdn.com/w320/co.png"
      heroImage="https://plus.unsplash.com/premium_photo-1697730015412-75b8223ae1fc?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Colombia-photo-guidelines.pdf" }],
      }}
      processingStages={[
