...
export default function DjiboutiEvisa() {
  return (
    <EVisaCountryPage
      country="Djibouti"
      title="Apply Djibouti E-Visa"
      flag="https://flagcdn.com/w320/dj.png"
      heroImage="https://images.unsplash.com/photo-1552796220-db7b4c3824a2?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1074"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Djibouti-photo-guidelines.pdf" }],
      }}
      processingStages={[
