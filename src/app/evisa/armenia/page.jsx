...
export default function ArmeniaEvisa() {
  return (
    <EVisaCountryPage
      country="Armenia"
      title="Apply Armenia E-Visa"
      flag="https://flagcdn.com/w320/am.png"
      heroImage="https://images.unsplash.com/photo-1654703551656-3a4060dfc6f1?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1025"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Armenia-photo-guidelines.pdf" }],
      }}
      processingStages={[
