...
export default function MorocoEvisa() {
  return (
    <EVisaCountryPage
      country="Moroco"
      title="Apply Moroco E-Visa"
      flag="https://flagcdn.com/w320/mr.png"
      heroImage="https://images.unsplash.com/photo-1624802704371-c76faa34c3a0?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170"
      ...
      documents={{
        ...
        downloads: [{ label: "Image Guidelines – Photo Specifications", href: "/docs/Moroco-photo-guidelines.pdf" }],
      }}
      processingStages={[
