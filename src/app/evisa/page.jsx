...
import { EVisa, getFlagBySlug } from "../../../data";
...
const VisasPage = () => {
  ...
  const filteredVisas = EVisa.filter((visa) =>
    visa.label.toLowerCase().includes(search.toLowerCase())
  );
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {currentVisas.map((visa, idx) => {
           ...
           return (
                ...
                <span className="text-zinc-800">{visa.label}</span>
                </Link>
            );
          })}
        </div>
